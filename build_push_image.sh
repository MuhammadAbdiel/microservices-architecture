...
echo $GITHUB_TOKEN | sudo docker login ghcr.io -u $github_account --password-stdin

# mengunggah image ke GitHub Container Registry
echo -e "\nPublishing image to GitHub Container Registry:"
sudo docker push ghcr.io/$github_account/$image_name:$image_version
